...
public class AppValidationMgr {
    ...
    //手机号表达式
    private final static Pattern phone_pattern = Pattern.compile("^((13[0-9])|(14[0-9])|(15[^4,\\D])|(17[0-9])|(18[0-9]))\\d{8}$");
...
//^(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{8,10}$
    ...
    public static boolean isIDCard(String IDCardNo) {
        ...
        try {
            ...
            e.printStackTrace();
            errmsg = "身份证生日不在有效范围";
            AppLogMessageMgr.e(errmsg + e.getMessage());
            return false;
        } catch (java.text.ParseException e1) {
            e1.printStackTrace();
            errmsg = "身份证生日不在有效范围";
            AppLogMessageMgr.e(errmsg + e1.getMessage());
            return false;
        }
     ...
     */
    public static boolean idHide2(String idCard) {
