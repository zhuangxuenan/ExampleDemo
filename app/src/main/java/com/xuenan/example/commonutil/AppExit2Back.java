...
public class AppExit2Back {
    ...
    public static boolean exitApp(Context context) {
        ...
        AppLogMessageMgr.i(isExit + "");
        AppLogMessageMgr.i("最大内存：" + Runtime.getRuntime().maxMemory());
        AppLogMessageMgr.i("占用内存：" + Runtime.getRuntime().totalMemory());
        AppLogMessageMgr.i("空闲内存：" + Runtime.getRuntime().freeMemory());
        return isExit;
    }
}
